...
class WordChord {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || (other is WordChord && word == other.word && chord == other.chord);
...
class ChordSheet {
  const ChordSheet({required this.title, required this.artist, this.key, required this.lines});
