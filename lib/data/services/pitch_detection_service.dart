...
/// each one (optionally on a compute isolate), passes the raw readings through
/// a [PitchSmoother] for temporal stability, and maps the smoothed frequency to
/// a note before emitting a [PitchDetection].
